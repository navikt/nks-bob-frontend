...
import { preloadFeedbacks, useFeedbacks, useUpdateFeedback } from "../../../../lib/api/admin"
import { Feedback } from "../../../../types/Message"
import { useStateLocalStorage } from "../../../../lib/utils/localStorage"
    ...
    <Box
      ...
      onClick={() =>
        feedback.messageId === null
          ? setPopoverOpen(true)
          : router.push(`/admin/${feedback.conversationId}?messageId=${feedback.messageId}`)
      }
