...
import { BodyShort, Button, Detail, Heading, HStack, Label, Loader, TextField, VStack } from "@navikt/ds-react"
import { format } from "date-fns"
import { FormEvent, useState } from "react"
import NextLink from "next/link"
import useSWR from "swr"
import { ApiError, fetcher } from "../../../../../lib/api/api"
...
const ConversationPreview = ({ conversation, messageId }: { conversation: Conversation; messageId?: string }) => {
  ...
  return (
    <VStack gap='space-12'>
      <Heading size='small'>
        <NextLink href={`/admin/${conversation.id}${queryParams}`}>
          Samtale med Bob
        </NextLink>
      </Heading>
